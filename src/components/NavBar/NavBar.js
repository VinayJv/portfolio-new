        ...
        <nav>
            ...
            <div className={`nav-menu`} style={{ animationName: animationClass, display: showNav ? "flex" : "none" }}>
                ...
                <div className="nav-options-container">
                    ...
                    <a href="https://drive.google.com/file/d/1ERXapevYToB0pHVSN4PpPaO6SYssGU-r/view?usp=sharing" download className={`${toggleClass ? "nav-connect-links-open" : "nav-connect-links-close"} download-btn`} style={toggleClass ? { animationDelay: `${350}ms`} : {animationDelay: `0s`}}>Download Resume</a>
                </div>
            </div>
        </nav>
    )
